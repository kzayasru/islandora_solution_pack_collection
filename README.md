...
Set the default number of collection objects per page, view style, display generation, objects per page during collection development, metadata display, and configuration options in Administration » Islandora » Core Collection (admin/islandora/basic_collection).
